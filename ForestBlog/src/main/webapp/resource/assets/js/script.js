...
function logout() {
    $.ajax({
        async: false,
        type: "POST",
        url: '/ForestBlog-1.0.0-SNAPSHOT/admin/logout',
...
function deleteComment(id) {
    if (confirmDelete() === true) {
        $.ajax({
            async: false,
            type: "POST",
            url: '/ForestBlog-1.0.0-SNAPSHOT/admin/comment/delete/' + id,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            dataType: "text",
            complete: function () {
                window.location.reload();
...
function increaseViewCount(articleId) {
    if ($.cookie("viewId") !== articleId || $.cookie("viewId") == null) {
        $.ajax({
            async: false,
            type: "POST",
            url: "/ForestBlog-1.0.0-SNAPSHOT/article/view/" + articleId,
            dataType: 'json',
...
$("#comment_form").submit(function () {
    $.ajax({
        async: false,
        type: "POST",
        url: '/ForestBlog-1.0.0-SNAPSHOT/comment',
        contentType: "application/x-www-form-urlencoded; charset=utf-8",
...
$("#applyLinkForm").submit(function () {
    $.ajax({
        async: false,
        type: "POST",
        url: '/ForestBlog-1.0.0-SNAPSHOT/applyLinkSubmit',
        contentType: "application/x-www-form-urlencoded; charset=utf-8",
